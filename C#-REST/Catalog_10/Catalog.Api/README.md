...
dotnet restore "Catalog.Api.csproj"
...
```
C:\Code\MyDotNet\C#-REST\Catalog>dotnet new xunit -n Catalog.UnitTests
The template "xUnit Test Project" was created successfully.

Processing post-creation actions...
Running 'dotnet restore' on Catalog.UnitTests\Catalog.UnitTests.csproj...
  Determining projects to restore...
  Restored C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\Catalog.UnitTests.csproj (in 9.84 sec).
Restore succeeded.

C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests>dotnet add reference ..\Catalog.Api\Catalog.Api.csproj
Reference `..\Catalog.Api\Catalog.Api.csproj` added to the project.
```

```
C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests>dotnet add package Microsoft.Extensions.Logging.Abstractions
  Determining projects to restore...
  Writing C:\Users\x239757\AppData\Local\Temp\tmpEA46.tmp
info : Adding PackageReference for package 'Microsoft.Extensions.Logging.Abstractions' into project 'C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\Catalog.UnitTests.csproj'.
info :   GET https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.logging.abstractions/index.json
info :   OK https://api.nuget.org/v3/registration5-gz-semver2/microsoft.extensions.logging.abstractions/index.json 436ms
info : Restoring packages for C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\Catalog.UnitTests.csproj...
info : Package 'Microsoft.Extensions.Logging.Abstractions' is compatible with all the specified frameworks in project 'C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\Catalog.UnitTests.csproj'.
info : PackageReference for package 'Microsoft.Extensions.Logging.Abstractions' version '6.0.0' added to file 'C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\Catalog.UnitTests.csproj'.
info : Committing restore...
info : Generating MSBuild file C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\obj\Catalog.UnitTests.csproj.nuget.g.targets.
info : Writing assets file to disk. Path: C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\obj\project.assets.json
log  : Restored C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\Catalog.UnitTests.csproj (in 397 ms).
```

```
C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests>dotnet add package moq
  Determining projects to restore...
  Writing C:\Users\x239757\AppData\Local\Temp\tmp5E1A.tmp
info : Adding PackageReference for package 'moq' into project 'C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\Catalog.UnitTests.csproj'.
info :   GET https://api.nuget.org/v3/registration5-gz-semver2/moq/index.json
info :   OK https://api.nuget.org/v3/registration5-gz-semver2/moq/index.json 466ms
info : Restoring packages for C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\Catalog.UnitTests.csproj...
info :   GET https://api.nuget.org/v3-flatcontainer/moq/index.json
info :   OK https://api.nuget.org/v3-flatcontainer/moq/index.json 313ms
info :   GET https://api.nuget.org/v3-flatcontainer/moq/4.17.2/moq.4.17.2.nupkg
info :   OK https://api.nuget.org/v3-flatcontainer/moq/4.17.2/moq.4.17.2.nupkg 43ms
info :   GET https://api.nuget.org/v3-flatcontainer/castle.core/index.json
info :   CACHE https://api.nuget.org/v3-flatcontainer/system.threading.tasks.extensions/index.json
info :   GET https://api.nuget.org/v3-flatcontainer/system.threading.tasks.extensions/4.5.4/system.threading.tasks.extensions.4.5.4.nupkg
info :   OK https://api.nuget.org/v3-flatcontainer/castle.core/index.json 123ms
info :   GET https://api.nuget.org/v3-flatcontainer/castle.core/4.4.1/castle.core.4.4.1.nupkg
info :   OK https://api.nuget.org/v3-flatcontainer/castle.core/4.4.1/castle.core.4.4.1.nupkg 35ms
info :   OK https://api.nuget.org/v3-flatcontainer/system.threading.tasks.extensions/4.5.4/system.threading.tasks.extensions.4.5.4.nupkg 216ms
...
info :   CACHE https://api.nuget.org/v3-flatcontainer/system.dynamic.runtime/index.json
info :   GET https://api.nuget.org/v3-flatcontainer/system.dynamic.runtime/4.3.0/system.dynamic.runtime.4.3.0.nupkg
info :   GET https://api.nuget.org/v3-flatcontainer/system.xml.xmldocument/index.json
info :   OK https://api.nuget.org/v3-flatcontainer/system.collections.specialized/index.json 63ms
info :   OK https://api.nuget.org/v3-flatcontainer/system.componentmodel/index.json 61ms
...
info :   OK https://api.nuget.org/v3-flatcontainer/system.componentmodel/4.3.0/system.componentmodel.4.3.0.nupkg 65ms
info :   OK https://api.nuget.org/v3-flatcontainer/system.collections.specialized/4.3.0/system.collections.specialized.4.3.0.nupkg 69ms
info :   GET https://api.nuget.org/v3-flatcontainer/system.collections.nongeneric/index.json
info :   OK https://api.nuget.org/v3-flatcontainer/system.collections.nongeneric/index.json 69ms
...
info :   OK https://api.nuget.org/v3-flatcontainer/system.collections.nongeneric/4.3.0/system.collections.nongeneric.4.3.0.nupkg 48ms
info :   OK https://api.nuget.org/v3-flatcontainer/system.dynamic.runtime/4.3.0/system.dynamic.runtime.4.3.0.nupkg 347ms
info :   OK https://api.nuget.org/v3-flatcontainer/system.diagnostics.tracesource/index.json 375ms
info :   OK https://api.nuget.org/v3-flatcontainer/system.componentmodel.typeconverter/index.json 378ms
info :   OK https://api.nuget.org/v3-flatcontainer/system.xml.xmldocument/index.json 367ms
info :   GET https://api.nuget.org/v3-flatcontainer/system.diagnostics.tracesource/4.3.0/system.diagnostics.tracesource.4.3.0.nupkg
...
info :   OK https://api.nuget.org/v3-flatcontainer/system.diagnostics.tracesource/4.3.0/system.diagnostics.tracesource.4.3.0.nupkg 67ms
info :   OK https://api.nuget.org/v3-flatcontainer/system.xml.xmldocument/4.3.0/system.xml.xmldocument.4.3.0.nupkg 68ms
info :   OK https://api.nuget.org/v3-flatcontainer/system.componentmodel.typeconverter/4.3.0/system.componentmodel.typeconverter.4.3.0.nupkg 68ms
info :   GET https://api.nuget.org/v3-flatcontainer/system.componentmodel.primitives/index.json
info :   OK https://api.nuget.org/v3-flatcontainer/system.componentmodel.primitives/index.json 56ms
...
info :   OK https://api.nuget.org/v3-flatcontainer/system.componentmodel.primitives/4.3.0/system.componentmodel.primitives.4.3.0.nupkg 68ms
...
info : Installing System.Dynamic.Runtime 4.3.0.
info : Installing System.Diagnostics.TraceSource 4.3.0.
info : Installing System.Collections.Specialized 4.3.0.
info : Installing System.ComponentModel 4.3.0.
info : Installing Castle.Core 4.4.1.
info : Installing System.Threading.Tasks.Extensions 4.5.4.
info : Installing Moq 4.17.2.
info : Package 'moq' is compatible with all the specified frameworks in project 'C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\Catalog.UnitTests.csproj'.
info : PackageReference for package 'moq' version '4.17.2' added to file 'C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\Catalog.UnitTests.csproj'.
info : Committing restore...
info : Writing assets file to disk. Path: C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\obj\project.assets.json
log  : Restored C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\Catalog.UnitTests.csproj (in 2.92 sec).
```
...
Processing post-creation actions...
Running 'dotnet restore' on C:\Code\MyDotNet\DotNet5-REST\Catalog\Catalog.Api.csproj...
  Determining projects to restore...
C:\Code\MyDotNet\DotNet5-REST\Catalog\Catalog.Api.csproj : error NU1100: Unable to resolve 'Swashbuckle.AspNetCore (>= 6.2.3)' for 'net6.0'.
  Failed to restore C:\Code\MyDotNet\DotNet5-REST\Catalog\Catalog.Api.csproj (in 217 ms).
Restore failed.
Post action failed.
...
```
C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests>dotnet test
  Determining projects to restore...
  All projects are up-to-date for restore.
  Catalog.Api -> C:\Code\MyDotNet\C#-REST\Catalog\Catalog.Api\bin\Debug\net5.0\Catalog.Api.dll
  Catalog.UnitTests -> C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\bin\Debug\net5.0\Catalog.UnitTests.dll
Test run for C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\bin\Debug\net5.0\Catalog.UnitTests.dll (.NETCoreApp,Version=v5.0)
...
Passed!  - Failed:     0, Passed:     1, Skipped:     0, Total:     1, Duration: 127 ms - Catalog.UnitTests.dll (net5.0)
```

```
C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests>dotnet add package FluentAssertions
  Determining projects to restore...
  Writing C:\Users\x239757\AppData\Local\Temp\tmp17B1.tmp
info : Adding PackageReference for package 'FluentAssertions' into project 'C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\Catalog.UnitTests.csproj'.
info :   GET https://api.nuget.org/v3/registration5-gz-semver2/fluentassertions/index.json
info :   OK https://api.nuget.org/v3/registration5-gz-semver2/fluentassertions/index.json 179ms
info : Restoring packages for C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\Catalog.UnitTests.csproj...
info :   GET https://api.nuget.org/v3-flatcontainer/fluentassertions/index.json
info :   OK https://api.nuget.org/v3-flatcontainer/fluentassertions/index.json 220ms
info :   GET https://api.nuget.org/v3-flatcontainer/fluentassertions/6.5.1/fluentassertions.6.5.1.nupkg
info :   OK https://api.nuget.org/v3-flatcontainer/fluentassertions/6.5.1/fluentassertions.6.5.1.nupkg 44ms
info :   GET https://api.nuget.org/v3-flatcontainer/system.configuration.configurationmanager/index.json
info :   OK https://api.nuget.org/v3-flatcontainer/system.configuration.configurationmanager/index.json 115ms
...
info :   OK https://api.nuget.org/v3-flatcontainer/system.configuration.configurationmanager/4.4.0/system.configuration.configurationmanager.4.4.0.nupkg 36ms
info :   GET https://api.nuget.org/v3-flatcontainer/system.security.cryptography.protecteddata/index.json
info :   OK https://api.nuget.org/v3-flatcontainer/system.security.cryptography.protecteddata/index.json 152ms
...
info :   OK https://api.nuget.org/v3-flatcontainer/system.security.cryptography.protecteddata/4.4.0/system.security.cryptography.protecteddata.4.4.0.nupkg 36ms
info : Installing System.Security.Cryptography.ProtectedData 4.4.0.
info : Installing System.Configuration.ConfigurationManager 4.4.0.
info : Installing FluentAssertions 6.5.1.
info : Package 'FluentAssertions' is compatible with all the specified frameworks in project 'C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\Catalog.UnitTests.csproj'.
info : PackageReference for package 'FluentAssertions' version '6.5.1' added to file 'C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\Catalog.UnitTests.csproj'.
info : Committing restore...
info : Writing assets file to disk. Path: C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\obj\project.assets.json
log  : Restored C:\Code\MyDotNet\C#-REST\Catalog\Catalog.UnitTests\Catalog.UnitTests.csproj (in 1.97 sec).
```
...
Processing post-creation actions...
Running 'dotnet restore' on Catalog\Catalog.Api.csproj...
  Determining projects to restore...
C:\Code\MyDotNet\DotNet5-REST\Catalog\Catalog.Api.csproj : error NU1100: Unable to resolve 'Swashbuckle.AspNetCore (>= 5.6.3)' for 'net5.0'.
  Failed to restore C:\Code\MyDotNet\DotNet5-REST\Catalog\Catalog.Api.csproj (in 164 ms).
Restore failed.
Post action failed.
...
Running 'dotnet restore' on Catalog\Catalog.Api.csproj...
  Determining projects to restore...
  Restored C:\Code\MyDotNet\Catalog\Catalog.Api.csproj (in 10.06 sec).
Restore succeeded.
```
...
info : Adding PackageReference for package 'MongoDB.Driver' into project 'C:\Code\MyDotNet\DotNet5-REST\Catalog\Catalog.Api.csproj'.
...
info : Restoring packages for C:\Code\MyDotNet\DotNet5-REST\Catalog\Catalog.Api.csproj...
...
info : Package 'MongoDB.Driver' is compatible with all the specified frameworks in project 'C:\Code\MyDotNet\DotNet5-REST\Catalog\Catalog.Api.csproj'.
info : PackageReference for package 'MongoDB.Driver' version '2.14.1' added to file 'C:\Code\MyDotNet\DotNet5-REST\Catalog\Catalog.Api.csproj'.
info : Committing restore...
info : Writing assets file to disk. Path: C:\Code\MyDotNet\DotNet5-REST\Catalog\obj\project.assets.json
log  : Restored C:\Code\MyDotNet\DotNet5-REST\Catalog\Catalog.Api.csproj (in 3.28 sec).
```

```dos
C:\Code\MyDotNet\DotNet5-REST\Catalog>dotnet user-secrets init
Set UserSecretsId to 'f30bdcb5-1fb2-43a7-820d-f76f5ff06912' for MSBuild project 'C:\Code\MyDotNet\DotNet5-REST\Catalog\Catalog.Api.csproj'.
...
info : Adding PackageReference for package 'AspNetCore.HealthChecks.MongoDb' into project 'C:\Code\MyDotNet\DotNet5-REST\Catalog\Catalog.Api.csproj'.
...
info : Package 'AspNetCore.HealthChecks.MongoDb' is compatible with all the specified frameworks in project 'C:\Code\MyDotNet\DotNet5-REST\Catalog\Catalog.Api.csproj'.
info : PackageReference for package 'AspNetCore.HealthChecks.MongoDb' version '6.0.1' added to file 'C:\Code\MyDotNet\DotNet5-REST\Catalog\Catalog.Api.csproj'.
info : Committing restore...
info : Writing assets file to disk. Path: C:\Code\MyDotNet\DotNet5-REST\Catalog\obj\project.assets.json
log  : Restored C:\Code\MyDotNet\DotNet5-REST\Catalog\Catalog.Api.csproj (in 1.99 sec).
```
